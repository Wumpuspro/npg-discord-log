...
export = async (client: Client, options?: { debug?: boolean }) => {
  ...
  if (intents.has("GUILDS")) {
    ...
    if (options?.debug)
      console.log(
        "channelUpdate, guildUpdate and roleUpdate event handlers not registered (missing GUILDS intent)."
      );
  }
  ...
  if (intents.has("GUILD_MEMBERS")) {
    ...
    if (options?.debug)
      console.log(
        "guildMemberUpdate, userUpdate event handlers not registered (missing GUILD_MEMBERS intents)."
      );
  }
  ...
  if (intents.has("GUILD_MESSAGES")) {
    ...
    if (options?.debug)
      console.log(
        "messageUpdate event handler not registered (missing GUILD_MESSAGES intent)."
      );
  }
  ...
  if (intents.has("GUILD_PRESENCES")) {
    ...
    if (options?.debug)
      console.log(
        "presenceUpdate event handler not registered (missing GUILD_PRESENCES intent)."
      );
  }
  ...
  if (intents.has("GUILD_VOICE_STATES")) {
    ...
    if (options?.debug)
      console.log(
        "voiceStateUpdate event handler not registered (missing GUILD_VOICE_STATES intent)."
      );
  }
};
